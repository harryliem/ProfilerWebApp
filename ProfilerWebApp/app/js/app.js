...
var App = angular.module('angle', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'tmh.dynamicLocale', 'ui.utils'])
          .run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
              ...
              // ----------------------------------- 
              $rootScope.app = {
                name: 'Academic Profiler',
                description: 'Academic Profiler Online System',
...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  // -----------------------------------   
    $stateProvider
    .state('app.uniscores-table', {
        url: '/uniscores-table',
        title: 'UniScores Table',
        templateUrl: 'app/custom/uniscores/uniscores-table.html',
        resolve: helper.resolveFor('datatables', 'datatables-pugins')
    })

        .state('app.uniscores-chart', {
            url: '/uniscores-chart',
            title: 'UniScores Chart',
            templateUrl: 'app/custom/uniscores/uniscores-chart.html',
